...
const { confirmComment, clearCart } = cartStore
const { cartData, totalFoodsPrice, orderData } = storeToRefs(cartStore)
...
<template>
  <div class="submitOrder">
    ...
    <div class="body">
      <div class="goods">
        <div v-for="(item, index) in cartData" :key="index" class="container">
